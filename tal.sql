...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2020 at 05:55 AM
...
INSERT INTO `users` (`uid`, `pwd`, `email`, `isAdmin`) VALUES
('admin', '$2y$10$Oog410yeGjp74lE1DFZgZ.ptT69wKNn6J7R0kE8Bxp6DETRpAanxG', 'admin@admin.com', 1),
('Zach', '$2y$10$GqWk9TE.CiZclNjIqDBFA.QNqmbn2rsf6bLt.vFvRpHF1OyJdqC0a', 'zach@zach.com', 1),
('RafaelCampos', '$2y$10$auBAmPexnUZ54IxtQJuQJ.at2WJcwULC7G5Rt/eiMoiDc86ZoVtLC', 'rcampos@email.com', 1),
('MeganGradey', '$2y$10$3wGLSt5ZkbDIZMdJbGsXRu1gs.y3XLkp/jzaZubHr0zqJDCrwf95i', 'mgradey@email.com', 1),
('HuiTian', '$2y$10$UYLa6tyAuJaAo/.ULU.RQuAxfn00asBGPk1eEbHRjC4a8hI.QnQTK', 'htian@email.com', 1),
('JanetSefton', '$2y$10$q6QqnSY7bnTbv4x3dAVCUeKb9A5McujSrnMuMrUcdBoYoC70Cgqz2', 'jsefton@email.com', 1);
...
--
ALTER TABLE `users`
  ADD UNIQUE KEY `uid` (`uid`) USING HASH;
COMMIT;
